...
#define btnPlay       A3            //Play Button
#define btnStop       A2            //Stop Button
#define btnUp         A1            //Up button
#define btnDown       2            //Down button
#define btnRoot       A0             //Return to SD card root
#define scrollSpeed   350           //text scroll delay
